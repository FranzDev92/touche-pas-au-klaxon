<div class="container my-4">
  ...
  <form method="post" action="/admin/trajet/<?=htmlspecialchars((string)$trajet['id'])?>/edit" class="row g-3">
    <div class="col-md-6">
      <label class="form-label" for="depart">Ville de départ</label>
      <input type="text" class="form-control" id="depart" name="depart" required value="<?=htmlspecialchars($trajet['depart'])?>">
    </div>

    <div class="col-md-3">
      <label class="form-label" for="date_depart">Date de départ</label>
      <input type="date" class="form-control" id="date_depart" name="date_depart" required value="<?=htmlspecialchars($trajet['date_depart'])?>">
    </div>
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="destination" name="destination" required value="<?=htmlspecialchars($trajet['destination'])?>">
    </div>
